# NIGHT03_PATCH2B_R1A_R6 — mask/plan freeze

## a01 tail (review-ledger closure verified; raw gates pre-validated, zero clipping)
...
- draft_authority_px: 24925
- review y set == final y set == draft authority y set
- accepted (whole canvas) == final source
- draft (whole canvas) == independent draft authority
- UNREVIEWED computed == 0

## a05 tail (review-ledger closure verified; raw gates pre-validated, zero clipping)
...
sources: data/assets_v2/annotation_sources/night03_patch2b_r1a_r6/ (static, read-only, never created or modified by this freeze)
