"""NIGHT-03 Recovery Patch 2A — verify the frozen mask plan (independent).
...
PLAN_DIR = ROOT / 'data/assets_v2/repair_candidates/night03_patch2/mask_plan'
...
def main():
    ...
    # 7. no candidate PNG anywhere under night03_patch2
