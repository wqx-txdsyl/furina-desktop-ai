"""NIGHT-03 Recovery Patch 2A R4 — complete frozen semantic masks (Builder).
...
def main():
    ...
    plan = {'task': 'NIGHT03_RECOVERY_PATCH2A_R4_MASK_FREEZE',
...
'''
    (OUT.parent / 'NIGHT03_PATCH2A_R4_MASK_FREEZE_REPORT.md').write_text(
        rep, encoding='utf-8')
    receipt = f'''PATCH_ID = NIGHT03_RECOVERY_PATCH2A_R4
BASE_SHA = {plan['base_sha']}
BRANCH = feature/night03-recovery-patch2
...
VERIFIER_SCANS_R4 = true
ALLOWED_PROTECTED_OVERLAP = 0
MASK_PLAN_SHA256 = {plan['MASK_PLAN_SHA256']}
MASTERS_UNCHANGED = true
PRODUCTION_FILES_CHANGED = 0
UNRELATED_FILES_COMMITTED = 0
REPORT = data/assets_v2/repair_candidates/night03_patch2a_r4/NIGHT03_PATCH2A_R4_MASK_FREEZE_REPORT.md
STATUS = READY_FOR_NIGHT03_PATCH2A_R4_REVIEW'''
    (OUT.parent / 'NIGHT03_PATCH2A_R4_RECEIPT.txt').write_text(
