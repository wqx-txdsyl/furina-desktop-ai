...
用法：
  python scripts/assets/gen_sequences.py --name sit_down --from standing --to sitting
  python scripts/assets/gen_sequences.py --name sit_down --from standing --to sitting --out data/assets
"""
...
log = get_logger("scripts.assets.gen_sequences")
